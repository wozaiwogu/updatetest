================================================================================
    MICROSOFT 基础类库 : MFCApplication1 项目概述
===============================================================================

应用程序向导已为您创建了此 MFCApplication1 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。

本文件概要介绍组成 MFCApplication1 应用程序的每个文件的内容。
...
MFCApplication1.h
    这是应用程序的主头文件。
    其中包括其他项目特定的标头（包括 Resource.h），并声明 AutoUnpackToolsApp 应用程序类。

MFCApplication1.cpp
    这是包含应用程序类 AutoUnpackToolsApp 的主应用程序源文件。
...
res\MFCApplication1.ico
    这是用作应用程序图标的图标文件。此图标包括在主资源文件 MFCApplication1.rc 中。
...
MFCApplication1Dlg.h、MFCApplication1Dlg.cpp - 对话框
    这些文件包含 CMFCApplication1Dlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 MFCApplication1.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 MFCApplication1.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
